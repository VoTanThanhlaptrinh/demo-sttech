...
/// <summary>
/// DTO nhận dữ liệu cập nhật nội dung và trạng thái FAQ.
/// </summary>
[AutoMapTo(typeof(FrequentlyAskedQuestion))]
public class UpdateFrequentlyAskedQuestionInput : EntityDto<int>, IShouldNormalize, IValidatableObject
{
    ...
    /// <summary>
    /// Trạng thái FAQ (Bắt buộc. Hợp lệ: Published = 1, Hidden = 2)
    /// </summary>
